  ...
  return (
    ...
    <View className="flex flex-col mt-10 gap-4 items-center justify-center" >
        <ImageViewer imgSource={PlaceholderImage} />
          <Text className='text-white font-semibold text-3xl mt-4' >Learn Anytime</Text>
          <Text className='text-white font-normal text-md text-justify' > Access courses on the go with our easy-to-use platform.</Text>
